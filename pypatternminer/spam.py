#!/usr/bin/env python3
"""
Python SPAM implementation for sequential pattern mining.
"""
...
class AlgoSPAM:
    ...
    def run_algorithm(
        ...
        # heuristic join counter: reuse total frequent pattern count for display
        self.join_count = self.number_of_frequent_patterns
    ...
    def print_statistics(self) -> str:
        ...
        sb.append(str(int(round(self.running_time()))))
        sb.append(" ms\n")
...
def main(output_path: Optional[Path] = None) -> None:
    ...
    algo = AlgoSPAM(support, mingap, maxgap, window_size, abstraction_creator)
    output_file = output_path or Path(__file__).with_name("spam_output.txt")
